...
---------------------------------
L4 offers a spreadsheet-based IDE
---------------------------------
...
--------------------------------------------
L4's text-mode IDE will be available in 2024
--------------------------------------------

For programmers who already have VS Code installed, an L4 editor with
LSP support will be coming in 2024.

-----------------------------
L4 contains a package library
-----------------------------

The L4 package library (currently in development) will offer reusable common components such as
